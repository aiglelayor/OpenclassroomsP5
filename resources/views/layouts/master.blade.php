...
\Gloudemans\Shoppingcart\Facades\Cart::count() }}</span>
        ...
        <div class="nav-scroller py-1 mb-2">
            <nav class="nav d-flex justify-content-between">
                <a class="p-2 link-secondary" href="#">Gâteaux</a>
                <a class="p-2 link-secondary" href="#">Évènement</a>
                <a class="p-2 link-secondary" href="#">À propos</a>
    ...
    <main class="container">
        <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
                <h1 class="display-4 fst-italic">Une recette délicieusement chocolatée</h1>
                <p class="lead my-3">Créer votre gâteau pour votre occasion. À deux ou à deux cent, le ChocoCoco se partage toujours ! </p>
